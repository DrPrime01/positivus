  ...
  return (
    <div className="flex flex-col gap-y-20 mb-[140px] mx-auto container">
      <div className="flex items-center gap-x-10">
        <h2 className="text-h2 p-1.5 rounded-sm bg-primary">Case Studies</h2>
        <p className="text-base text-wrap max-w-[520px]">
      ...
      <div className="px-[60px] py-[70px] flex items-center gap-x-16 bg-dark rounded-[45px] divide-x divide-white">
        <div className="flex flex-col gap-y-5 pr-16">
          ...
          <Link
            to="/case-studies"
            className="flex items-center gap-x-3.5 text-regular text-primary"
          >
            <span>Learn more</span>
            <ArrowRightTop className="size-4" />
          </Link>
        </div>
        <div className="flex flex-col gap-y-5 pr-16">
          <p className="text-base text-white">
